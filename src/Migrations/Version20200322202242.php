 ...
 */
final class Version20200322202242 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE evaluation ADD slug VARCHAR(255) NOT NULL, CHANGE enseignant_id enseignant_id INT DEFAULT NULL, CHANGE groupe_id groupe_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE evaluation DROP slug, CHANGE enseignant_id enseignant_id INT DEFAULT NULL, CHANGE groupe_id groupe_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE groupe_etudiant CHANGE tree_root tree_root INT DEFAULT NULL, CHANGE parent_id parent_id INT DEFAULT NULL');
